...
<%-- 			<%} %> --%>
	...
	<section id = "writeButton">
			<a href="OrderDeliveryDetail.adm">배송 디테일입니다</a><br>
		<br>
		<a href=""><input type="button" value="완료"></a>
<!-- 		<a href="OrderDeletePro.adm"><input type="button" value="멤버삭제"></a> -->

...
<%-- 			<%} %> --%>
	...
	<section id = "writeButton">
			<a href="OrderRefundDetail.adm">환불 리스트입니다</a><br>
		<br>
		<a href=""><input type="button" value="완료"></a>
<!-- 		<a href="OrderRefundDeletePro.adm"><input type="button" value="환불삭제"></a> -->
...
<!-- 												<a href="MemberList.amd">[BEFORE]</a>&nbsp; -->
